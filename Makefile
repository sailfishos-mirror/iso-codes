...
pkgdatadir = $(datadir)/dist-bzip2
pkglibdir = $(libdir)/dist-bzip2
pkgincludedir = $(includedir)/dist-bzip2
top_builddir = .
...
DIST_COMMON = README COPYING ChangeLog INSTALL Makefile.am Makefile.in \
	TODO aclocal.m4 config.guess config.sub configure configure.ac \
	install-sh iso-codes.pc.in missing mkinstalldirs
...
iso-codes.pc: $(top_builddir)/config.status iso-codes.pc.in
...
distdir: $(DISTFILES)
	$(am__remove_distdir)
	mkdir $(distdir)
	$(mkinstalldirs) $(distdir)/. $(distdir)/debian
